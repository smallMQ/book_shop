                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        ...
                        <div class="chapter-item" v-for="chapter in course_chapters" :key="chapter.name">
                            <p class="chapter-title"><img src="@/assets/img/enum.png" alt="">第{{chapter.chapter}}章·{{chapter.name}}
                            </p>
                            <ul class="section-list">
                                <li class="section-item" v-for="section in chapter.coursesections" :key="section.name">
                                    ...
                                    <p class="time">{{section.duration}} <img src="@/assets/img/chapter-player.png"></p>
        ...
        data() {
            return {
                ...
                playerOptions: {
                    ...
                    sources: [{ // 播放资源和资源格式
                        type: "video/mp4",
                        src: "http://qxwzuferc.hn-bkt.clouddn.com/9175226c8e4989188d9a196c172ee448.mp4" //你的视频地址（必填）
                    }],
                }
            }
        },
